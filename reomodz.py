...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using REOMODZ');exit()
...
logo=("""\
   ...
   \033[1;32md888888b .d8888. db   db db    db db    db 
     \033[1;32m`88'   88'  YP 88   88 88    88 88    88 
      \033[1;32m88    `8bo.   88ooo88 88    88 88    88 
      \033[1;32m88      `Y8b. 88~~~88 88    88 88    88 
     \033[1;32m.88.   db   8D 88   88 88b  d88 88b  d88 
   \033[1;32mY888888P `8888Y' YP   YP ~Y8888P' ~Y8888P'\033[1;32m XIX
\033[1;32m--------------------------------------------------
