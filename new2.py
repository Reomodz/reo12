...
C='\033[0m' #CLEAR
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Instagram 207.0.0.28.118 (iPhone10,6; iOS 14_7_1; ru_RU; ru-RU; scale=3.52; 1125x2436; 320361397) NW/3"
...
[white][[blue]03[white]]. Crack Dari Mengikuti           [white][[red]E[white]]. [red]LogOut """,title=f"[{P2} Pilihan Menu {hapus}]",width=80,padding=(0,4),style=f"{color_table}"))
	...
	def mentod(self):
		...
		try:
			...
			met = ses.get('https://app.cryptolens.io/api/key/Activate?token=WyI3NzEzOTcxMiIsImFlU09aRnUydGtxMk9vclhlOVJGYVRBQzVmdHN6QzRTaUUxeHRIWnoiXQ==&ProductId=5&Key='+lisen).json()
			men = met['licenseKey']
			key = men['key'][0:16]
...
def lisensi():
 try:
  ...
  tlisensi()
 ses=requests.Session()
 res=ses.get('https://app.cryptolens.io/api/key/Activate?token=WyI3NzEzOTcxMiIsImFlU09aRnUydGtxMk9vclhlOVJGYVRBQzVmdHN6QzRTaUUxeHRIWnoiXQ==&ProductId=5&Key='+lisensikuni[0]).json()
